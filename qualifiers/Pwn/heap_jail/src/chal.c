...
void locked(){
    ...
    printf("You try to open the locked gate...\n");
    sleep(1);
    printf("It doesn't budge an inch");
    return;
    }
...
void scream(){
    ...
    printf("A cell changes...\n");
    printf("Which cell would you like to remove?\n>");
    ...
    if (!cells[idx]){
        printf("Cell is already free!\n");
        return;
    }
    free(cells[idx]);
    printf("So screaming does remove cells huh\n");
    return;
}
